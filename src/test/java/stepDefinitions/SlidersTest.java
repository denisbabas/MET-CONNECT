...
public class SlidersTest extends CommonMethods{
	...
	CommonMethods.click(instrumentConfigurationPageElementsOne.InstrumentConfigurationContinuedTab);
	}
	...
	public void check_Enable_checkbox_and_get_values_from_Frequency_Low_and_Frequency_High_in_section_N5532A_B(Integer int1, Integer int2) throws Throwable {
		...
		CommonMethods.click(instrumentConfigurationPageElementsOne.enableN5532AB);
		
		
		WebElement Low = instrumentConfigurationPageElementsOne.textFromAllIntBox.get(0);
		String text1 = Low.getAttribute("Name");
		
		FiveHundredForFreguencyLowBefore = text1;
		WebElement High = instrumentConfigurationPageElementsOne.textFromAllIntBox.get(1);
	...
	public void verify_Five_Hundred_For_Freguency_dropdowns_and_sliders_are_enabled() {
		...
		Assert.assertTrue(instrumentConfigurationPageElementsOne.comboBoxMeasurementFrequencyHigh.isEnabled());
		Assert.assertTrue(instrumentConfigurationPageElementsOne.comboBoxMeasurementFrequencyLow.isEnabled());
	
		Assert.assertTrue(instrumentConfigurationPageElementsOne.sliderUp.get(0).isEnabled());
		Assert.assertTrue(instrumentConfigurationPageElementsOne.sliderUp.get(1).isEnabled());
	}
	...
	public void drag_Five_Hundred_For_Frequency_Low_slider_and_drop_it_somewhere_at_the_middle_of_its_line() {
      CommonMethods.click((instrumentConfigurationPageElementsOne.sliderUp).get(0));
	...
	public void drag_Five_Hundred_For_Frequency_High_slider_and_drop_it_somewhere_at_the_middle_of_its_line() {
		 ...
		 CommonMethods.click((instrumentConfigurationPageElementsOne.sliderUp).get(1));
	}
